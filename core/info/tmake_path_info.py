...
class PathInfo(object):
    ...
    def get_auto_tmake_xml_path(self, project_name):
        """
        获取 tmake xml文件夹
        :param project_name:
        :return:
        """
        return os.path.join(self.publish_path, project_name, 'tmake_xml')
    ...
    def get_package_zip_path(self, name):
        ...
        file_name = '{}_{}_{}_{}.zip'.format(name, core.data.target, self.arch, core.data.build_config)
